...
vae_kmeans, vae_kmeans_metrics, vae_kmeans_df = run_KMeans(z_reduced, model_type="hard_2_cvae_audio_lyrics", root=root, k_range=range(2, 20), true_labels=vae_labels)
vae_dbscan, vae_dbscan_metrics, vae_dbscan_df  = run_DBSCAN(z_reduced, model_type="hard_2_cvae_audio_lyrics", root=root, true_labels=vae_labels)
vae_agglomerative, vae_agglomerative_metrics, vae_agglomerative_df = run_Agglomerative(z_reduced, model_type="hard_2_cvae_audio_lyrics", root=root, k_range=range(2, 20), true_labels=vae_labels)
...
plot_latent_space_by_cluster(
    ...
    method=method,
    save_path=TSNE_DIR/f"hard_2_cvae_audio_lyrics_kmeans_{method}",
    plot_title=f"{method.upper()} Visualization of Conditional VAE Clusters using K_Means (Audio + Lyrics)"
)
...
plot_latent_space_by_cluster(
    ...
    method=method,
    save_path=TSNE_DIR/f"hard_2_cvae_audio_lyrics_dbscan_{method}",
    plot_title=f"{method.upper()} Visualization of Conditional VAE Clusters using DB-SCAN (Audio + Lyrics)"
)
...
plot_latent_space_by_cluster(
    ...
    method=method,
    save_path=TSNE_DIR/f"hard_2_cvae_audio_lyrics_agglomerative_{method}",
    plot_title=f"{method.upper()} Visualization of Conditional VAE Clusters using Agglomerative Clustering (Audio + Lyrics)"
)