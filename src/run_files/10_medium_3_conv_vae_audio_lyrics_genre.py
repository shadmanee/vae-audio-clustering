...
vae_kmeans, vae_kmeans_metrics, vae_kmeans_df = run_KMeans(z_reduced, model_type="medium_3_conv_vae_audio_lyrics_genre", root=root, k_range=range(2, 20))
vae_dbscan, vae_dbscan_metrics, vae_dbscan_df  = run_DBSCAN(z_reduced, model_type="medium_3_conv_vae_audio_lyrics_genre", root=root)
vae_agglomerative, vae_agglomerative_metrics, vae_agglomerative_df = run_Agglomerative(z_reduced, model_type="medium_3_conv_vae_audio_lyrics_genre", root=root, k_range=range(2, 20))
...
plot_latent_space_by_cluster(
    ...
    method=method,
    save_path=TSNE_DIR/f"medium_3_conv_vae_audio_lyrics_genre_kmeans_{method}",
    plot_title=f"{method.upper()} Visualization of Convolutional VAE Clusters using K_Means (Audio + Lyrics + Genre)"
)
...
plot_latent_space_by_cluster(
    ...
    method=method,
    save_path=TSNE_DIR/f"medium_3_conv_vae_audio_lyrics_genre_dbscan_{method}",
    plot_title=f"{method.upper()} Visualization of Convolutional VAE Clusters using DB-SCAN (Audio + Lyrics + Genre)"
)
...
plot_latent_space_by_cluster(
    ...
    method=method,
    save_path=TSNE_DIR/f"medium_3_conv_vae_audio_lyrics_genre_agglomerative_{method}",
    plot_title=f"{method.upper()} Visualization of Convolutional VAE Clusters using Agglomerative Clustering (Audio + Lyrics + Genre)"
)