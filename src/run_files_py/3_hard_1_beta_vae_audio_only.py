...
weight_path, cfg_path = save_model(model=beta_vae, model_name="hard_1_beta_vae_audio_only", cfg=beta_vae.config, root=root, num_classes=0)
...
vae_kmeans, vae_kmeans_metrics, vae_kmeans_df = run_KMeans(vae_latents, model_type="hard_1_beta_vae_audio_only", root=root, k_range=range(2, 20))
vae_dbscan, vae_dbscan_metrics, vae_dbscan_df  = run_DBSCAN(vae_latents, model_type="hard_1_beta_vae_audio_only", root=root)
vae_agglomerative, vae_agglomerative_metrics, vae_agglomerative_df = run_Agglomerative(vae_latents, model_type="hard_1_beta_vae_audio_only", root=root, k_range=range(2, 20))
